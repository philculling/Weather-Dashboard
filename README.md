...
Write a to do list to try to break it down. As you're going along, try to put things into a sensible order and with things that are able to be tested as you go along.
Read the blog on API keys.
As you get to each new section, break it down further.
Then break it down further still into things you can succeed at and test, even if they don't directly fulfil the task. For example work out how to search by co-ordinates, or work out how to console log the data even if you then afterwards need to work out how to display it. Another example: you could test an event listener just to make sure that works. 
